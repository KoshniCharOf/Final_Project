...
public class Article {
	...
	//TODO private Set<Media> mediaFiles;//!!!Set<Integer> media_id???
	
	
	
	
	public Article(long id, String title, String textContent, long category_id, boolean isLeading) {
		this(title,textContent, category_id, isLeading);
		this.id = id;
